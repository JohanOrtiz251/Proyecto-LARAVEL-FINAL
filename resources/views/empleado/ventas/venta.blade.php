<x-emple-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="w-full flex justify-center">
                <a href="{{ route('listado-ventas') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6">
                ...
                <form method="GET" action="{{ route('ventas-empleado') }}" class="mb-4 flex items-center">
                    ...
                    <div class="border border-gray-300 dark:border-gray-700 rounded-lg p-4 bg-white dark:bg-gray-800">
                        ...
                        <div class="flex items-center justify-between mt-4">
                            ...
                            <div class="flex space-x-2">
                                ...
                                <a href="{{ route('empleado.ventas', $product->id) }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Vender</a>
                            </div>
                        </div>
                    </div>
                    @endforeach
