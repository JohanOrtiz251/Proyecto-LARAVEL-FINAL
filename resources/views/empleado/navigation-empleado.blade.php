        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="{{ route('instrucciones') }}" :active="request()->routeIs('instrucciones')">
                        {{ __('Instrucciones') }}
                    </x-nav-link>
                </div>
                ...
                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="{{ route('empleado.inicio') }}" :active="request()->routeIs('empleado')">
                        {{ __('Dashboard') }}
                    </x-nav-link>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="{{ route('historial-movimientos') }}" :active="request()->routeIs('historial-movimientos')">
