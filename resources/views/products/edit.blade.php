                ...
                <div class="p-6">
                    ...
                    <form action="{{ route('products.update', $product->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="reorder_level" id="reorder_level" class="mt-1 p-2 border rounded-md w-full dark:bg-gray-700 dark:border-gray-600 dark:text-white" value="{{ $product->reorder_level }}" required>
                        </div>
                        <div class="mb-4">
